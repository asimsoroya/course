...
namespace DoctrineORMModule\Proxy\__CG__\Course\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CourseCategory extends \Course\Entity\CourseCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Course\\Entity\\CourseCategory' . "\0" . 'id', '' . "\0" . 'Course\\Entity\\CourseCategory' . "\0" . 'name', '' . "\0" . 'Course\\Entity\\CourseCategory' . "\0" . 'description', '' . "\0" . 'Course\\Entity\\CourseCategory' . "\0" . 'left', '' . "\0" . 'Course\\Entity\\CourseCategory' . "\0" . 'right', '' . "\0" . 'Course\\Entity\\CourseCategory' . "\0" . 'parentCategory');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CourseCategory $proxy) {
